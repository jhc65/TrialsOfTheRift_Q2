Update 2.1
Fixed issue with shadows while disintegrating.
Updated Hologram script to work with multi-part game objects
Added "PowerUp" and "PowerDown" effects to Hologram.
Added CrystalPBR shader for gem/frozen effects.
Added Frozen and FrozenController to freeze and thaw characters.

Update 2.0
Added PBR shaders for Statue, Beam, 
